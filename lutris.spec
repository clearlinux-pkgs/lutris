...
Version  : 0.5.18
Release  : 48
URL      : https://github.com/lutris/lutris/archive/v0.5.18/lutris-0.5.18.tar.gz
Source0  : https://github.com/lutris/lutris/archive/v0.5.18/lutris-0.5.18.tar.gz
...
%prep
%setup -q -n lutris-0.5.18
cd %{_builddir}/lutris-0.5.18
pushd ..
cp -a lutris-0.5.18 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733164429
...
/usr/share/lutris/json/supermodel.json
...
/usr/share/lutris/ui/download-queue.ui
