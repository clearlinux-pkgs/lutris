...
Version  : 0.5.19
Release  : 49
URL      : https://github.com/lutris/lutris/archive/v0.5.19/lutris-0.5.19.tar.gz
Source0  : https://github.com/lutris/lutris/archive/v0.5.19/lutris-0.5.19.tar.gz
...
%prep
%setup -q -n lutris-0.5.19
cd %{_builddir}/lutris-0.5.19
pushd ..
cp -a lutris-0.5.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740410222
