...
Version  : 0.5.16
Release  : 45
URL      : https://github.com/lutris/lutris/archive/v0.5.16/lutris-0.5.16.tar.gz
Source0  : https://github.com/lutris/lutris/archive/v0.5.16/lutris-0.5.16.tar.gz
...
%prep
%setup -q -n lutris-0.5.16
cd %{_builddir}/lutris-0.5.16
pushd ..
cp -a lutris-0.5.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705419017
